...
def main():
    ...
    input_df = pd.read_excel('Country_Data_2020.xlsx')
    ...
    democracy_data = democracy_all_years[democracy_all_years["Year"] == 2020]
    ...
    output_df1.to_excel("Inequality Index Values 2020 10-1.xlsx")
